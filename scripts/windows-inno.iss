#define MyAppName "RaccoonLine VPN"
#define MyAppVersion "0.5.0.5"
#define MyAppPublisher "RaccoonLine"
#define MyAppExeName "RaccoonLine.exe"

[Setup]
AppId=05219b69-b170-4ff9-b04d-8fa381c0f46d
AppName={#MyAppName}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf64}\{#MyAppName}
DisableProgramGroupPage=yes
OutputBaseFilename=RaccoonLine_Setup_{#MyAppVersion}
Compression=lzma
...
[Files]
Source: "RaccoonLine.exe"; DestDir: "{app}"; Flags: ignoreversion

...
foreach(FOLDER ${FOLDER_LIST})
    ...
    if(IS_DIRECTORY "${FULL_PATH}" AND ${FOLDER} STREQUAL "raccoon-core")
        message(STATUS "Found [raccoon-core] by path: ${FULL_PATH}")
        set(RACCOON_CORE ${FULL_PATH} CACHE STRING "Description of raccoon_core.")
    endif()
endforeach()

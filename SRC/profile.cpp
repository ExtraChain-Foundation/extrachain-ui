...
void Profile::setValue(const QString &field, const QByteArray &value) {
    ...
    if (index < 0 || index > m_list.length() - 1) {
        eLog("Profile list: \"index out of range\" for field {} and value {}", field, value);
        return;
    }
...
QStringList Profile::avatar() const {
    QString avatar = value("avatar").simplified();
    if (avatar.isEmpty())
        return {};
    return avatar.split(" ");
}
...
QStringList Profile::portfolio() {
    QString portfolio = value("portfolio").simplified();
...
bool Profile::isServiceExists(ServiceCheckType checkType) const {
...
const QMap<int, QString> Profile::categoryMap { { 0, "Editorial" },  { 1, "Mature" }, { 2, "Child" },
                                                ...
                                                { 6, "Fitness" },    { 7, "Plus" } };
const QMap<int, QString> Profile::bodyMap { { 0, "Petit" },
                                            { 1, "Average" },
                                            { 2, "Thin" },
                                            { 3, "Athletic" },
                                            { 4, "Heavy" } };
const QMap<int, QString> Profile::hairMap { { 0, "Blonde" },    { 1, "Dark Blonde" }, { 2, "Light Blonde" },
...
const QMap<int, QString> Profile::skinMap { { 0, "Tattoo" }, { 1, "Brand" }, { 2, "Piercing" }, { 3, "Scar" } };
...
const QMap<int, QString> Profile::workStyleMap { { 0, "White-color" }, { 1, "Blue-color" }, { 2, "Art" },
                                                 { 3, "Act" },         { 4, "Portrait" },   { 5, "Glamour" },
                                                 { 6, "Fashion" },     { 7, "Event" } };
const QMap<int, QString> Profile::fashionMap { { 0, "Photographer" },
                                               { 1, "Affiliate" },
                                               { 2, "Designer" },
                                               { 3, "Visagiste" },
                                               { 4, "Stylist" } };

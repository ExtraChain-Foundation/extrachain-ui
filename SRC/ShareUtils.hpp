...
public:
    ...
    virtual bool checkMimeTypeView(const QString &mimeType) {
        eLog("check view for  {}", mimeType);
        return true;
    }
    virtual bool checkMimeTypeEdit(const QString &mimeType) {
        eLog("check edit for  {}", mimeType);
        return true;
    }
    ...
    virtual void sendFile(const QString &filePath,
                          ...
                          const int     &requestId,
                          const bool    &altImpl) {
        eLog("{}  -  {} requestId  {}  -  {} altImpl?  {}", filePath, title, requestId, mimeType, altImpl);
    }
    ...
    virtual void editFile(const QString &filePath,
                          const QString &title,
                          const QString &mimeType,
                          const int     &requestId,
                          const bool    &altImpl) {
    ...
    virtual void checkPendingIntents(const QString workingDirPath) {
        eLog("checkPendingIntents  {}", workingDirPath);
    }
};
...
public:
    ...
    Q_INVOKABLE void sendFile(const QString &filePath,
                              ...
                              const int     &requestId,
                              const bool    &altImpl);
    Q_INVOKABLE void viewFile(const QString &filePath,
                              const QString &title,
                              const QString &mimeType,
                              const int     &requestId,
                              const bool    &altImpl);
    Q_INVOKABLE void editFile(const QString &filePath,
                              const QString &title,
                              const QString &mimeType,
                              const int     &requestId,
                              const bool    &altImpl);

...
void AndroidUtils::shareFile(const QString &filePath) {
  ...
  QJniObject::callStaticMethod<void>(
      "com/extrachain/app/AndroidUtils", "shareFile",
...
// Sets screen orientation based on device type (portrait for phones,
// unspecified for tablets)
...
void AndroidUtils::setWakeLock(bool active) {
  ...
  QJniObject context = QNativeInterface::QAndroidApplication::context();
  if (!context.isValid()) {
    eInfo("AndroidUtils::setWakeLock() - Failed to get Android application "
          "context");
    return;
  }
  ...
  QJniObject::callStaticMethod<void>(
      "com/extrachain/app/AndroidUtils", "setWakeLock",
      "(Landroid/content/Context;Z)V", context.object(), active);

  eInfo("{}",
        QString("AndroidUtils::setWakeLock(%1) - Call completed successfully")
...
bool AndroidUtils::requestBatteryOptimizationExemption() {
  ...
  QJniObject activity = QJniObject::callStaticObjectMethod(
      ...
      "()Landroid/app/Activity;");
  if (!activity.isValid()) {
    eInfo("{}", "AndroidUtils::requestBatteryOptimizationExemption() - Failed "
                "to get Android activity");
    return false;
  }

  jboolean result = QJniObject::callStaticMethod<jboolean>(
      "com/extrachain/app/AndroidUtils", "requestBatteryOptimizationExemption",
      "(Landroid/app/Activity;)Z", activity.object());

  eInfo("{}",
        QString(
            "AndroidUtils::requestBatteryOptimizationExemption() - Result: %1")
...
bool AndroidUtils::isBatteryOptimizationExempted() {
  ...
  QJniObject context = QNativeInterface::QAndroidApplication::context();
  if (!context.isValid()) {
    eInfo("AndroidUtils::isBatteryOptimizationExempted() - Failed to get "
          "Android application context");
    return false;
  }

  jboolean result = QJniObject::callStaticMethod<jboolean>(
      "com/extrachain/app/AndroidUtils", "isBatteryOptimizationExempted",
...
void AndroidUtils::registerNetworkCallback() {
  ...
  QJniObject context = QNativeInterface::QAndroidApplication::context();
  if (!context.isValid()) {
    eInfo("AndroidUtils::registerNetworkCallback() - Failed to get Android "
          "application context");
    return;
  }

  QJniObject::callStaticMethod<void>(
      "com/extrachain/app/AndroidUtils", "registerNetworkCallback",
      "(Landroid/content/Context;)V", context.object());

  eInfo(
      "AndroidUtils::registerNetworkCallback() - Network callback registered");
#endif
}
...
void AndroidUtils::unregisterNetworkCallback() {
  ...
  QJniObject context = QNativeInterface::QAndroidApplication::context();
  if (!context.isValid()) {
    eInfo("AndroidUtils::unregisterNetworkCallback() - Failed to get Android "
          "application context");
    return;
  }

  QJniObject::callStaticMethod<void>(
      "com/extrachain/app/AndroidUtils", "unregisterNetworkCallback",
      "(Landroid/content/Context;)V", context.object());

  eInfo("AndroidUtils::unregisterNetworkCallback() - Network callback "
        "unregistered");
#endif
}
...
void AndroidUtils::enableWebSocketKeepAlive() {
  ...
  QJniObject context = QNativeInterface::QAndroidApplication::context();
  if (!context.isValid()) {
    eInfo("AndroidUtils::enableWebSocketKeepAlive() - Failed to get Android "
          "application context");
    return;
  }

  QJniObject::callStaticMethod<void>(
      "com/extrachain/app/AndroidUtils", "enableWebSocketKeepAlive",
      "(Landroid/content/Context;)V", context.object());

  eInfo("AndroidUtils::enableWebSocketKeepAlive() - WebSocket connection "
        "support activated");
#endif
}
...
void AndroidUtils::setupStatusBar() {
  ...
  if (activity.isValid()) {
    QJniObject::callStaticMethod<void>(
        "com/extrachain/app/AndroidUtils", "setupStatusBar",
...
int AndroidUtils::getStatusBarHeight() {
  ...
  if (activity.isValid()) {
    return QJniObject::callStaticMethod<jint>(
        "com/extrachain/app/AndroidUtils", "getStatusBarHeight",
        "(Landroid/app/Activity;)I", activity.object());
  }
...
bool AndroidUtils::installApk(const QString &filePath) {
  ...
  QJniObject::callStaticMethod<void>(
      "com/extrachain/app/UpdaterHelper", "setContext",
      "(Landroid/content/Context;)V", activity.object());

  QJniObject::callStaticMethod<void>("com/extrachain/app/UpdaterHelper",

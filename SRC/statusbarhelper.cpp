...
float StatusBarHelper::getStatusBarHeight() {
  ...
  QJniObject statusBarHelper("com/extrachain/app/StatusBarHelper",
...
bool StatusBarHelper::hasNotch() {
  QJniObject activity = QJniObject::callStaticObjectMethod(
      "org/qtproject/qt/android/QtNative", "activity",
      "()Landroid/app/Activity;");
  QJniObject displayHelper("com/extrachain/app/StatusBarHelper",
                           "(Landroid/app/Activity;)V",
                           activity.object<jobject>());
...
float StatusBarHelper::getNavigationBarHeightForOrientation() {
  ...
  QJniObject statusBarHelper("com/extrachain/app/StatusBarHelper",
                             "(Landroid/app/Activity;)V",
                             activity.object<jobject>());
  return statusBarHelper.callMethod<jfloat>(
      "getNavigationBarHeightForOrientation");
}
...
QList<float> StatusBarHelper::getSystemWindowInsets() {
  ...
  QJniObject statusBarHelper("com/extrachain/app/StatusBarHelper",
                             "(Landroid/app/Activity;)V",
                             activity.object<jobject>());
  QJniObject insetsArray =
      statusBarHelper.callObjectMethod("getSystemWindowInsets", "()[F");
...
float StatusBarHelper::getStatusBarHeight() { return 0.f; }

bool StatusBarHelper::hasNotch() { return false; }

QRectF StatusBarHelper::getNotchSize() { return QRectF(); }

float StatusBarHelper::getNavigationBarHeight() { return 0.f; }

bool StatusBarHelper::hasNavigationBar() { return false; }

float StatusBarHelper::getNavigationBarHeightForOrientation() { return 0.f; }

bool StatusBarHelper::isGestureNavigationEnabled() { return false; }

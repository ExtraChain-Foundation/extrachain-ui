...
#ifdef Q_OS_IOS
//    #include "ui/iosshareutils.hpp"
#endif

#ifdef Q_OS_ANDROID
// #include "ui/androidshareutils.hpp"
#endif
...
//    mPlatformShareUtils = new IosShareUtils(this);
    ...
    //    Q_ASSERT(connectResult);
    //
    //    connectResult = connect(mPlatformShareUtils,
    //                            &PlatformShareUtils::shareNoAppAvailable,
    //                            this,
    //                            &ShareUtils::onShareNoAppAvailable);
    //    Q_ASSERT(connectResult);
    //
    //    connectResult = connect(mPlatformShareUtils, &PlatformShareUtils::shareError, this,
    //    &ShareUtils::onShareError); Q_ASSERT(connectResult);
    //
    //    connectResult =
    //        connect(mPlatformShareUtils, &PlatformShareUtils::fileUrlReceived, this,
    //        &ShareUtils::onFileUrlReceived);
    //    Q_ASSERT(connectResult);
    //
    //    connectResult = connect(mPlatformShareUtils,
    //                            &PlatformShareUtils::fileReceivedAndSaved,
    //                            this,
...
void ShareUtils::sendFile(const QString &filePath,
                          const QString &title,
...
void ShareUtils::viewFile(const QString &filePath,
                          const QString &title,
                          const QString &mimeType,
                          const int     &requestId,
                          const bool    &altImpl) {
...
void ShareUtils::editFile(const QString &filePath,
                          const QString &title,
                          const QString &mimeType,
                          const int     &requestId,
                          const bool    &altImpl) {
